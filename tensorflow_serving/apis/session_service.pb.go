...
import fmt "fmt"
import math "math"
import protobuf "github.com/maxhawkins/tensorflow-serving-go/tensorflow/core/protobuf"
...
func (*SessionRunRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_service_d40c0166abc91dca, []int{0}
}
...
func (*SessionRunResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_service_d40c0166abc91dca, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/session_service.proto", fileDescriptor_session_service_d40c0166abc91dca)
}

var fileDescriptor_session_service_d40c0166abc91dca = []byte{

...
func (*IteratorStateMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_iterator_6a25783a1abaeea7, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/iterator.proto", fileDescriptor_iterator_6a25783a1abaeea7)
}

var fileDescriptor_iterator_6a25783a1abaeea7 = []byte{

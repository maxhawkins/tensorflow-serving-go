...
func (*NamedTensorProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_named_tensor_f0e76b7312aaf7e5, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/named_tensor.proto", fileDescriptor_named_tensor_f0e76b7312aaf7e5)
}

var fileDescriptor_named_tensor_f0e76b7312aaf7e5 = []byte{

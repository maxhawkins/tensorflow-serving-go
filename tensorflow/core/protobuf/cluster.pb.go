...
func (*JobDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_950513adeed734a8, []int{0}
}
...
func (*ClusterDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_950513adeed734a8, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/cluster.proto", fileDescriptor_cluster_950513adeed734a8)
}

var fileDescriptor_cluster_950513adeed734a8 = []byte{
